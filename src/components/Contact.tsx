...
export default function Contact() {
  ...
  const copyEmail = () => {
    navigator.clipboard.writeText("amntoppo@gmail.com");
    setCopied(true);
    ...
    <section id="contact" className="py-24 px-6">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="text-slate-400 text-lg mb-12 max-w-xl mx-auto">
          ...
          Feel free to reach out for Mobile Engineering roles or project collaborations.
        </p>

        <div className="glass rounded-2xl p-8 md:p-12 mb-12">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
            <a href="mailto:amntoppo@gmail.com" className="btn-primary text-lg">
